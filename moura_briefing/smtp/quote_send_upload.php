...
if (isset($_FILES['fileupload']))
	...
	$expensions = array(
		...
		"doc",
		"pdf"
	); // Define with files are accepted
	...
	if (in_array($file_ext, $expensions) === false)
		{
		$errors[] = "Extension not allowed, please choose a gif, jpg, jpeg, .png, .doc, .pdf file.";
		}
...
$mail->SetFrom("chegouleads@joggadigital.com.br", "Cadastro Revenda Digital");
...
$mail->Subject = "Cadastro Revenda Digital";
